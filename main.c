...
{   case 1:
        while(1){
           ...
           scanf("%d" ,&student[i].math1) ;     Math1 += student[i].math1 ;
           printf("student score in math2: ") ;
           scanf("%d" ,&student[i].math2) ;     Math2 += student[i].math2 ;
           printf("student score in Intro to CS: ") ;
           scanf("%d" ,&student[i].cs) ;           CS += student[i].cs ;
           printf("student score in Intro to IS: ") ;
           scanf("%d" ,&student[i].is) ;           IS += student[i].is ;
           printf("student score in Intro to PL: ") ;
           scanf("%d" ,&student[i].pl) ;           PL += student[i].pl ;
